...
if __name__ == '__main__':
    pandaset = DataSet('/media/echo/仓库卷/DataSet/Autonomous Driving/PandaSets/pandaset')
    seq = pandaset['002']
    seq.load()
    # seg_anno_np = np.array(seq.semseg.data, ndmin=2)
    print(pandaset.sequences(with_semseg=True))
    # print(seq.semseg.data[0])
